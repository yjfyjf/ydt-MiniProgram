	...
	<view class="city-select">
		<scroll-view :scroll-top="scrollTop" scroll-y="true" class="city-select-main" id="city-select-main" :scroll-into-view="toView">
			...
			<view class="hot-city" v-if="activeCity && !serachCity">
				...
				<!-- <view class="mol-flex mt-10px j-content" @click="getLocation">
					<image src="/static/image/location.png" class="w-20px h-20px" mode="aspectFit"></image>
					<text class="font-14px col-A5A5A5 ml-10px">重新定位</text>
				</view> -->
			<!-- </view> -->
			<!-- 热门城市 -->
